...
exports.default = {
    ...
    VALIDATION_ERROR_FORMAT_FIRST_LETTER: 'Formato incorrecto para el campo {field}. Ingrese un solo caracter alfabetico',
    ...
    SPECIALTY_REPEATED_TREATMENT_PLAN: 'Un plan de tratamiento no puede tener especialidades y modalidades repetidas.',
    MODALITY_ERROR: "La modalidad ingresada es incorrecta. Las modalidades permitidas son 'presence' o 'virtual'. ",
    TYPE_PRACTICE_ERROR: "El tipo de practica ingresada es incorrecta. Los tipos permitidos son 'image', 'laboratory' or 'others'. ",
    TYPE_FIELD_ERROR: "El tipo de campo ingresado es incorrecto. Los tipos permitidos son 'label','group','input','checkbox','radio','select','select_multiple','datetime','date','time','chips' o 'chips_multiple'",
    ...
    CURRENT_DATE_HIGHER_THAN_START_DATE: 'La toma de medicamentos ya comenzo y no es posible editar la fecha de inicio.',
    SESSION_ERROR_QUANTITY: 'La sesión del plan de tratamiento tiene {appointments} registrados. La cantidad no puede ser menor a {appointments}.',
    ...
    PROFESSIONAL_DONT_HAVE_AVAILABILITY: 'El professional no tiene diponibilidad horaria en el o en alguno de los periodos indicados',
    ...
    SPECIALTY_AVAILABILITY_NOT_FOUND_IN_PROFESSIONS: 'La especialidad {name} ingresada en disponibilidad no existe en las profesiones del profesional',
    ...
    REPROGRAMMING_SAME_DATE_AND_TIME: 'No se puede reprogramar un turno para la misma fecha y hora en la que estaba programado.',
    NAME_TEMPLATE_ALREADY_EXIST: 'El nombre ingresado para la plantilla ya existe. Cambie el nombre o elimine la plantilla anterior.',
    //report appointment
