...
router.post('/', [isAuth_1.default, express_validator_1.check('name', 'El nombre es obligatorio').notEmpty(), validate_fields_1.validate_fields], characteristics_controllers_1.postCharacteristic);
router.put('/:id', [isAuth_1.default, express_validator_1.check('name', 'El nombre es obligatorio').notEmpty(), validate_fields_1.validate_fields], characteristics_controllers_1.putCharacteristic);
