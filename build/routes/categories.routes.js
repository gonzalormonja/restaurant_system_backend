...
router.delete('/:id', [isAuth_1.default, express_validator_1.param('id', 'El id debe ser de tipo numerico y es obligatorio').isInt().notEmpty(), validate_fields_1.validate_fields], categories_controllers_1.deleteCategory);
