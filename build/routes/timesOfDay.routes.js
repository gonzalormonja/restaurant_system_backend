...
router.post('/', [
    isAuth_1.default,
    (0, express_validator_1.body)('hour_start')
        .isString()
        .custom((input) => (0, validate_fields_1.validate_time)(input, 'hour_start')),
    (0, express_validator_1.body)('hour_end')
        .isString()
        .custom((input) => (0, validate_fields_1.validate_time)(input, 'hour_end')),
...
router.delete('/:id', [isAuth_1.default, (0, express_validator_1.param)('id', 'El id debe ser de tipo numerico y es obligatorio').isInt().notEmpty(), validate_fields_1.validate_fields], timesOfDay_controllers_1.deleteTimeOfDay);
